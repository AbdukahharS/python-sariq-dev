...
![Github.com sahifasi](../cirth-assets/753b1826-d48e-4aac-a307-284891203214.png)
...
![Profaylni yangilash](../cirth-assets/92ca4e6a-57ac-47f3-a228-257befc52554.png)
...
![python.sariq.dev uchun public repository](../cirth-assets/77a6eab8-ff43-4451-870b-13208daf812d.png)

### LOYIHALARIMIZ UCHUN REPOSITORY YARATAMIZ

Bo'sh repository yaratish uchun, github.com sahifasida **New** tugmasini bosamiz.

![Yangi repository yaratamiz](../cirth-assets/b907299c-a9a6-4803-a050-553307d241ad.png)
...
1. Repository ommaga ochiq (public)yoki yopiq (private) bo'lishini tanlaymiz. Buni keyin ham o'zgartirish mumkin.
1. README faylini qo'shish (qo'shmalikni) tanlaymiz. README faylida siz loyiha haqida batafsil ma'lumot berishingiz mumkin. Agar loyiha omma uchun bo'lsa albatta README faylini ham tanlang va loyihangiz haqida ma'lumot bering.
1. Create Repository tugmasini bosamiz.

![Repository yaratamiz ](../cirth-assets/ced8b422-d713-4230-aeaf-e87aa0518002.png)

Marhamat, repository tayyor. O'ng burchakdagi qalam tugmasini bosib, README faylini o'zgartirishimiz mumkin.

![Yangi repository](../cirth-assets/55031fb1-3bf1-4fbb-af78-daa4ac7080ab.png)
...
![GitHub Desktop sahifasi](../cirth-assets/c85237fd-0480-4dd3-a266-dd291d23ed6d.png)
...
![GitHub desktop](../cirth-assets/c4754516-ae76-4cff-9d4a-758406bb5d75.png)

Yangi ochilgan oynada Repository uchun kompyuterimizda joy tanlaymiz:

![Yangi Repository uchun joy tanlaymiz](../cirth-assets/78ab1352-833f-49f2-9880-4b90b2107c73.png)
...
![Bo'sh Repository](../cirth-assets/02a7b29b-8145-4c80-a761-ee812f26bee0.png)

File Manager yordamida yuqoridagi Repository uchun yaratilgan papkaga kodlaringizni ko'chiring va GitHub desktop dasturiga qayting. Papkadagi barcha o'zgarishlar GitHub desktopda ham paydo bo'ldi. O'zgarishlarni Repositorga qo'shish uchun, _Summary_ degan joyda o'zgarishlar haqida qisqacha ma'lumot bering va **Commit to main** tugmasini bosing.

![O'zgarishlarni Repositoryga yuklaymiz](../cirth-assets/05069f41-d98d-4b54-a353-b6b2b15ff36c.png)

Va nihoyat, Repositoryni onlyanga yuklash uchun **Push origin** tugmasini bosing:

![Repositoryni onlaynga yuklaymiz](../cirth-assets/a7f360a3-e12f-412c-9d7d-63b4bd967363.png)
...
![Repository yangilandi](../cirth-assets/9fa8f68f-24ec-4faa-9406-362decf85d75.png)
...
![Repositoryni ko'chirib olish](../cirth-assets/f2c0717d-7cba-4cd5-b504-0750ad1aa803.png)

Yuqoridagi ka'bi Repository uchun kompyuterimizda yangi joy tanlaymiz, va Clone tugmasini bosamiz.

![Repository uchun joy tanlaymiz](../cirth-assets/0c6b15cb-c23a-4a4b-8357-90bd507c7b91.png)
...
1. Kompyuteringizga [GitHub Desktop ](https://desktop.github.com/)dasturini o'rnating
1. GitHubda Python darslari uchun yangi repository yarating
1. Shu vaqtgacha yozgan kodlaringizni yangi repositoryga yuklang
1. Sahifamizga qo'yib borilayotgan mashg'ulotlarning javoblarini quyidagi [repositorydan ](https://github.com/anvarnarz/python-darslar)o'zingizga Clone qilib oling:
